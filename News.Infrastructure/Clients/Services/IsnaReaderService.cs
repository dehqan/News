...
{
    public class IsnaReaderService : IReaderService
    {
        private readonly IApiService _apiService;
        private readonly ILogger<IsnaReaderService> _logger;

        public IsnaReaderService(IApiService apiService, ILogger<IsnaReaderService> logger)
        {
        ...
        {
            var data = await _apiService.SendRequest<IsnaRssResult>(ApiMethodEnum.GET, ApiSerializerEnum.XML, url);
